...
class TestModulus(BaseOperationTest):
    ...
    invalid_test_cases = {
        "modulus_by_zero": {
            ...
            "b": "0",
            "error": ValidationError,
            "message": "Modulus by zero is undefined"
        },
    }
...
class TestIntegerDivision(BaseOperationTest):
    ...
    invalid_test_cases = {
        "division_by_zero": {
            ...
            "b": "0",
            "error": ValidationError,
            "message": "Integer division by zero is undefined"
        },
    }
...
class TestPercentage(BaseOperationTest):
    ...
    valid_test_cases = {
        "basic_percentage":       {"a": "50",  "b": "200", "expected": "25"},
        "full_percentage":        {"a": "100", "b": "100", "expected": "100"},
        "zero_numerator":         {"a": "0",   "b": "100", "expected": "0"},
        "decimal_percentage":     {"a": "1",   "b": "3",   "expected": "33.33333333333333333333333333"},
    }
    invalid_test_cases = {
        "zero_base": {
            "a": "50",
            "b": "0",
            "error": ValidationError,
            "message": "Cannot calculate percentage of zero base value"
        },
    }
...
class TestAbsoluteDifference(BaseOperationTest):
    ...
    valid_test_cases = {
        "basic_difference":       {"a": "10",  "b": "3",   "expected": "7"},
        "reversed_operands":      {"a": "3",   "b": "10",  "expected": "7"},
        "both_negative":          {"a": "-5",  "b": "-10", "expected": "5"},
        "equal_numbers":          {"a": "7",   "b": "7",   "expected": "0"},
    }
    invalid_test_cases = {}
